...
class AvataaarGenerator extends StatelessWidget {
  ...
  final AvatarPicture? avatarPicture;
    ...
    return Column(
      ...
      children: [
        ...
        if (avataaar.top.topType != TopType.eyepatch)
          typeBuilder(
            context,
            AccessoriesType.values.indexOf(avataaar.top.accessoriesType),
            ...
            onTranslateKey(
                accessoriesTypeNames[avataaar.top.accessoriesType.index]),
            onTranslateKey('accessories'),
            'bowtie',
            (index) {
              avataaar.top.accessoriesType = AccessoriesType.values[index];
              onUpdateAvataaar?.call();
            },
          ),
        //FacialHairType
  ...
  Expanded typeBuilder(
    ...
    if (sectionBuilder != null) {
      return Expanded(
        child: sectionBuilder!(context, index, itemsCount, onTap,
            currentSelected, type, icon, onUpdate),
      );
    }
    return Expanded(
      child: Row(
